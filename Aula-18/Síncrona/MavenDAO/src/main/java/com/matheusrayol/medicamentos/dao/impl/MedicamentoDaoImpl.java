package com.matheusrayol.medicamentos.dao.impl;

import com.matheusrayol.medicamentos.dao.ConfiguracaoJdbc;
...
public class MedicamentoDaoImpl implements IDao<Medicamento> {
    ...
    public Medicamento salvar(Medicamento medicamento) {
        ...
        try {
            ...
            if (resultSet.next()) medicamento.setId(resultSet.getInt(1));
            connection.close();
